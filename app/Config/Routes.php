...
//Route Export Data Tagihan
$routes->get('/tagihan/export-excel', 'Tagihan::exportExcel');
$routes->get('/tagihan/export-word', 'Tagihan::exportWord');
$routes->get('/tagihan/export-pdf', 'Tagihan::exportPDF');
